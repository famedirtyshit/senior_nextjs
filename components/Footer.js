...
export default function Footer(prop) {
  return (
    <section
      className={cn({
        'footer-orange 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center bg-historyBlue': prop.color == 'blue',
        'footer-orange 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center bg-mainBgGreen': prop.color != 'blue',
      })}
