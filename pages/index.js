...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: 'Prompt' }} className={" mx-auto " + HomeStyle.bgImg}>
      ...
      <header className="flex flex-wrap justify-between items-center xl:mx-64 lg:mx-32 md:mx-24 sm:mx-12 mx-2 pt-3">
        <h1 className="sm:text-7xl text-base cursor-pointer font-black">Catus</h1>
        {
          userAccount == null
            ?
            ...
            <div className="account-action">
              <div onClick={handleOpenAccountMenu} className='flex flex-wrap cursor-pointer'>
                <p className="sm:text-lg text-xs sm:text-white text-black">
      ...
      <main className="xl:mt-64 lg:mt-28 mt-6 relative">
        <section className="about lg:ml-64 md:ml-32 sm:ml-24 ml-2 md:w-4/12 sm:w-6/12">
          {/* <h1 className="text-7xl font-black">
            About <span className="text-mainOrange">CatUs</span>
          </h1> */}
          <div className="sm:w-96 sm:h-14 w-52">
            <svg viewBox="0 0 455 56" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap md:gap-5 gap-2 xl:mt-8 md:mt-2 ">
            <BaseButton
              ...
              roundSize={"lg"}
              value={"Get Started"}
              customClass={"sm:mt-2 mt-2 sm:w-auto w-3/5"}
            ...
            <Link href="/feed">
              <a>
                <BaseButton
                  ...
                  customClass={"sm:mt-2 border-2 border-yellow-400 sm:w-auto w-3/5"}
                ></BaseButton>
              </a>
            </Link>
          </div>
        </section>
        <section className="cat-img absolute 2xl:-top-24 xl:-top-44 lg:-top-20 md:top-2 sm:top-0 top-5 right-0 2xl:right-52 lg:right-0 md:right-8 sm:right-2 h-auto lg:w-5/12 md:w-4/12 w-4/12">
          <Image
            priority={'eager'}
        ...
        <section className="down-botton sm:flex hidden  flex-wrap justify-end 2xl:mt-40 lg:mt-20 md:mt-0 sm:-mt-8">
          <div className="lg:mr-28 md:mr-12 sm:mr-8">
            <Image
              priority={'eager'}
        ...
        <section
          ...
          id="section1"
        >
          <div className="bg-mainGreen h-10 sm:hidden"></div>
          <h1 id='statement' style={{ textShadow: '0px 4px 4px rgba(0,0,0,0.25)' }} className="2xl:text-5xl lg:text-3xl md:text-xl font-black md:text-white sm:text-black text-white text-center sm:block hidden">
            Statement of the problems
          </h1>
          <div className="text xl:mt-10 lg:mt-6 sm:mt-2 bg-mainYellow sm:bg-transparent">
          <h1 id='statement' style={{ textShadow: '0px 4px 4px rgba(0,0,0,0.25)' }} className="2xl:text-5xl lg:text-3xl md:text-xl font-black md:text-white sm:text-black text-white text-center sm:hidden block sm:py-0 py-4">
            Statement of the problems
          </h1>
            <p style={{ textShadow: '0px 4px 4px rgba(0,0,0,0.3)' }} className="md:text-white sm:text-black text-white 2xl:text-2xl xl:text-lg lg:text-base md:text-sm text-xs">
            ...
            <p style={{ textShadow: '0px 4px 4px rgba(0,0,0,0.3)' }} className="md:text-white sm:text-black text-white 2xl:text-2xl xl:text-lg lg:text-base md:text-sm text-xs sm:pb-0 pb-2">
              <span className="mr-10" />
        ...
        <section className="why-catUs-container 2xl:mt-60 xl:mt-48 lg:mt-28 md:mt-24 sm:mt-20 mt-8 xl:mr-60 xl:ml-52 lg:mx-28 md:mx-16">
          ...
          <section className="flex flex-wrap justify-center 2xl:mt-32 xl:mt-20 lg:mt-8 md:mt-4 mt-2 ">
            <div
              className="shadow-2xl rounded-3xl lg:w-6/12 md:w-6/12 sm:w-5/12 w-10/12 h-auto"
              style={{
            ...
            <div className="mx-auto lg:mt-9 sm:mt-2 mt-8 xl:w-5/12">
              <p style={{ textShadow: '0px 4px 4px rgba(0,0,0,0.25)' }} className="text-black 2xl:text-4xl xl:text-2xl lg:text-xl font-black text-center">
                เพราะช่วยเพิ่มโอกาสสำเร็จในการตามหาแมวหายให้กับผู้ใช้งาน
              </p>
              <p style={{ textShadow: '0px 4px 4px rgba(0,0,0,0.25)' }} className="text-black 2xl:text-2xl xl:text-lg lg:text-base font-medium lg:mt-6 md:mt-4 sm:mt-0 mt-4 text-center">
          ...
          <section className="flex flex-wrap 2xl:mt-48 xl:mt-72 lg:mt-28 md:mt-3 mt-12 justify-center bg-mainGreen sm:bg-transparent sm:py-0 py-4">
            <div className="lg:mr-16 md:mt-12 mt-2 xl:w-5/12 lg:w-4/12" >
              ...
              <p
                className="text-white 2xl:text-2xl xl:text-lg text-base font-medium mt-6 2xl:w-auto md:mx-auto mx-8 sm:mb-0 mb-2"
                style={{ textShadow: '0px 4px 4px rgba(0,0,0,0.25)' }}
              >
            ...
            <div
              className="shadow-2xl rounded-3xl xl:w-5/12 lg:w-6/12 md:w-5/12 sm:w-4/12 w-10/12 h-auto"
              style={{
                backgroundColor: "#FFFFFF",
              }}
            >
        ...
        <section className="howToUse xl:mt-96 lg:mt-44 md:mt-28 mt-16">
          <p className="sm:text-5xl text-2xl font-black text-center">
            CatUs ใช้งานง่ายแค่ 5 ขั้นตอน
          </p>
          <p className="text-left mx-auto mt-8 sm:text-2xl text-lg font-medium sm:w-4/6 w-5/6">
          ...
          <div className="grid sm:grid-cols-2 gap-7 lg:mt-36 mt-16 ">
            <div className=" mt-24 sm:relative">
              <div className="sm:absolute lg:left-96 lg:top-20 md:left-48 sm:left-36 md:top-0 flex justify-center">
                <Image
                  priority={'eager'}
              ...
              <div className="sm:absolute lg:ml-48 lg:left-16 xl:left-20 lg:top-72 md:top-52 sm:top-52 md:left-36 sm:left-28 w-3/5 flex flex-col justify-center mx-auto">
                <p className="md:text-4xl text-xl font-bold text-center ">
                  Search Post
                </p>
                <p className="md:text-2xl text-lg md:mt-6 mt-2 text-left ">
          ...
          <div className="grid sm:grid-cols-2 gap-7 mt-52 ">
            ...
            <div className=" mt-24 relative">
              <div className="sm:absolute lg:left-96 lg:top-28 md:left-48 sm:top- sm:left-36 md:top-0 flex justify-center">
                <Image
                  priority={'eager'}
              ...
              <div className="sm:absolute lg:ml-48 lg:left-10 lg:top-72 md:top-44 sm:top-36 sm:left-24 md:left-36 xl:left-16 w-3/5 flex flex-col justify-center mx-auto">
                <p className="md:text-4xl text-xl font-bold text-center ">
                  Function Post
                </p>
                <p className="md:text-2xl text-lg md:mt-6 mt-2 text-left ">
          ...
          <div className="grid sm:grid-cols-2 gap-7 mt-52 ">
            <div className=" mt-24 relative">
              <div className="sm:absolute lg:left-96 md:left-48 sm:top-0 sm:left-36 lg:top-28 md:top-0 flex justify-center">
                <Image
                  priority={'eager'}
              ...
              <div className="sm:absolute lg:ml-48 lg:left-16 lg:top-72 md:top-44 md:left-28 sm:top-44 sm:left-28 w-3/5 flex flex-col justify-center mx-auto">
                <p className="md:text-4xl text-xl font-bold text-center ">
                  Dashboard
                </p>
                <p className="lg:text-2xl md:text-xl text-sm md:mt-6 mt-2 text-left ">
          ...
          <div className="grid sm:grid-cols-2 gap-7 mt-52 ">
            ...
            <div className=" mt-24 relative">
              <div className="sm:absolute lg:left-96 lg:top-24 md:top-0 sm:top-0 sm:left-36 md:left-48 flex justify-center">
                <Image
                  priority={'eager'}
              ...
              <div className="sm:absolute lg:ml-48 lg:left-8 xl:left-20 lg:top-72 md:top-44 sm:top-44 sm:left-32 md:left-28 w-3/5 flex flex-col justify-center mx-auto">
                <p className="md:text-4xl text-xl font-bold text-center ">
                  My Account
                </p>
                <p className="md:text-2xl text-lg md:mt-6 mt-2 text-left ">
          ...
          <div className="grid sm:grid-cols-2 gap-7 mt-52 ">
            <div className=" mt-24 relative">
              <div className="sm:absolute lg:left-96 lg:top-10 md:left-48 md:top-0 sm:left-36 sm:-top-12 flex justify-center">
                <Image
                  priority={'eager'}
              ...
              <div className="sm:absolute lg:ml-48 lg:left-16 lg:top-64 md:top-44 sm:top-32 md:left-28 sm:left-28 w-3/5 flex flex-col justify-center mx-auto">
                <p className="md:text-4xl text-xl font-bold text-center ">
                  Finally, you succeeded
                </p>
                <p className="lg:text-2xl md:text-lg text-base md:mt-6 mt-2 text-left ">
                  เมื่อคุณเจอน้องแมวที่คุณตามหาแล้ว คุณสามารถ กดเข้าไปเพื่อดู ข้อมูลเพิ่มเติมและข้อมูลติดต่อของ เจ้าของโพสต์ได้เลย<br />
                  <span className="font-base md:text-sm text-xs w-full inline-block text-right pr-8 lg:mt-5 md:mt-1">
      ...
      <footer className="md:mt-32 mt-36">
        <section
          className="footer-orange flex flex-col justify-center items-center bg-mainYellow"
          ...
          <Link href="/feed">
            <a>
              <BaseButton
                ...
                roundSize={"lg"}
                value={"Looking for your cat"}
                customClass={"ml-4 w-72 h-14 md:mt-12 mt-6"}
              ></BaseButton>
            </a>
          </Link>
        </section>
