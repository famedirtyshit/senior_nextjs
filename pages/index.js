...
export default function Home() {
  ...
  return (
    <div
      ...
      className={" mx-auto " + HomeStyle.bgImg}
    >
      <Head>
        <title>CatUs</title>
      ...
      <header className="2xl:flex 2xl:flex-wrap 2xl:justify-between 2xl:mx-64 2xl:pt-3 xl:flex xl:flex-wrap xl:justify-between xl:mx-40 xl:pt-3">
        <h1 className="2xl:text-7xl 2xl:cursor-pointer 2xl:font-black xl:text-7xl xl:cursor-pointer xl:font-black">
          Catus
        </h1>
        {userAccount == null ? (
            ...
            >
              <p className="text-lg text-white">
                {userAccount.firstname
                  ? userAccount.firstname.length > 15
                    ? userAccount.firstname.substring(0, 15) + "... "
                    : userAccount.firstname + " "
                  : null}
                {userAccount.lastname
                  ? userAccount.lastname.length > 15
                    ? userAccount.lastname.substring(0, 15) + "... "
                    : userAccount.lastname + " "
                  : null}
              </p>
      ...
      <main className="2xl:mt-64 2xl:relative xl:mt-36 xl:relative">
        <section className="about 2xl:ml-64 2xl:w-4/12 xl:ml-44 xl:w-4/12">
          ...
          <p className="mt-6 text-textGray font-normal text-lg">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Catus
            เป็นเว็บไซต์สำหรับประกาศตามหาแมวหรือประกาศตามหา เจ้าของแมว
            เพื่อช่วยให้แมวหลงสามารถกลับคืนสู่เจ้าทาสของตัวเองได้
          </p>
          <div className="2xl:flex 2xl:flex-wrap 2xl:gap-5 2xl:mt-8 xl:flex xl:flex-wrap xl:gap-5 xl:mt-8">
            <BaseButton
              style={"color: white"}
              fill={true}
              ...
              roundSize={"lg"}
              value={"Get Started"}
              customClass={"2xl:mt-4 xl:mt-4"}
              onClickFunction={() => {
                let top = document.getElementById("statement").offsetTop;
            ...
            <Link href="/feed">
              <a>
                <BaseButton
                  ...
                  customClass={
                    "2xl:mt-4 2xl:border-2 2xl:border-yellow-400 xl:mt-4 xl:border-2 xl:border-yellow-400"
                  }
                ></BaseButton>
              </a>
            </Link>
        ...
        <section className="cat-img 2xl:absolute 2xl:-top-24 2xl:right-52 xl:absolute xl:-top-24 xl:right-52  " >
        {/* <section className={classes.catModal}> */}
          <Image
            ...
            height="536"
          />
          {/* <img src={IMAGES.catModalHomePage} alt="catModel" className="xl:w-9/12 xl:h-9/12" />  */}
        </section>
        <section className="down-botton 2xl:flex 2xl:flex-wrap 2xl:justify-end 2xl:mt-40 xl:flex xl:flex-wrap xl:justify-end xl:mt-4">
          <div className="2xl:mr-28 xl:mr-16  ">
            <Image
        ...
        <section
          className="about-catUs-conatainer 2xl:w-3/5 2xl:mt-24 2xl:mx-auto xl:w-4/6 mt-4 xl:mx-auto"
          title="section1"
          id="section1"
        >
          <h1
            ...
            className="2xl:text-5xl 2xl:font-black 2xl:text-white 2xl:text-center xl:text-4xl xl:font-black xl:text-white xl:text-center"
          >
            Statement of the problems
          </h1>
          <div className="text 2xl:mt-10 xl:mt-8">
            <p
              style={{ textShadow: "0px 4px 4px rgba(0,0,0,0.3)" }}
              className="text-white 2xl:text-2xl xl:text-xl"
            >
              <span className="2xl:mr-10 xl:mr-10" />
            ...
            <p
              style={{ textShadow: "0px 4px 4px rgba(0,0,0,0.3)" }}
              className="2xl:text-white 2xl:text-2xl xl:text-white xl:text-xl"
            >
        ...
        <section className="why-catUs-container 2xl:mt-60 2xl:mr-60 2xl:ml-52 xl:mt-24 xl:mr-60 xl:ml-52">
          <p
            className="2xl:text-black 2xl:text-4xl 2xl:font-black 2xl:text-center 2xl:mt-32 xl:text-black xl:text-3xl xl:font-black xl:text-center xl:mt-32" /**style={{textShadow:"-2px 4px #6B7280"}}**/
            style={{ textShadow: "0px 4px 4px rgba(0,0,0,0.25)" }}
          >
            ทำไมต้องใช้ CatUs
          </p>
          <section className="2xl:flex 2xl:flex-wrap 2xl:justify-center 2xl:mt-32 xl:flex xl:flex-wrap xl:justify-center xl:mt-20">
            <div
              className="2xl:shadow-2xl 2xl:rounded-3xl 2xl:relative xl:shadow-2xl xl:rounded-3xl xl:relative"
              style={{
            ...
            >
              <div className="2xl:absolute  2xl:left-20 2xl:top-24 xl:absolute  xl:left-20 xl:top-24">
                <Image
                  src={IMAGES.whyUse1}
                  alt="whyUse1"
                  width="766"
            ...
            <div
              className="2xl:ml-16 2xl:mt-9 xl:ml-16 xl:mt-9"
              style={{ width: "559px" }}
            >
              <p
                style={{ textShadow: "0px 4px 4px rgba(0,0,0,0.25)" }}
                className="2xl:text-black 2xl:text-4xl 2xl:font-black 2xl:text-center xl:text-black xl:text-2xl xl:font-black xl:text-center"
              >
                เพราะช่วยเพิ่มโอกาสสำเร็จในการตามหาแมวหายให้กับผู้ใช้งาน
              </p>
              <p
                style={{ textShadow: "0px 4px 4px rgba(0,0,0,0.25)" }}
                className="2xl:text-black 2xl:text-2xl 2xl:font-medium 2xl:mt-6"
              >
                จากการที่ระบบมีการฟิลเตอร์ข้อมูลสถานที่ในการค้นหาและสามารถแยกประเภทข้อมูลสำหรับการ
                ค้นหาได้ ทำให้ผู้ใช้สามารถตามหาแมวที่หายไปได้
          ...
          <section className="2xl:flex 2xl:flex-wrap 2xl:mt-48 2xl:justify-center">
            ...
            <div
              className="2xl:shadow-2xl 2xl:rounded-3xl 2xl:relative"
              style={{
                backgroundColor: "#FFFFFF",
                width: "673px",
                height: "534px",
            ...
            >
              <div className="2xl:absolute 2xl:left-1 2xl:top-7">
                <Image
                  src={IMAGES.whyUse2}
                  alt="whyUse2"
                  width="715"
        ...
        <section className="howToUse 2xl:mt-96">
          ...
          <p className="text-left mx-auto mt-8 text-2xl font-medium w-4/6">
            &nbsp;&nbsp;&nbsp;หากผู้ใช้งานต้องการดูข้อมูลของแมวที่หายไปหรือแมวที่ถูกพบเจอสามารถเริ่มต้นใช้งานได้เลย
            แต่หากผู้ใช้ต้องการ
            โพสต์ข้อมูลของตนเองจำเป็นต้องทำการล็อคอินเข้าระบบก่อน
            เพื่อที่จะสามารถเข้าถึงฟังก์ชั่นต่างๆของ CatUs ได้
          </p>
            ...
            <div className=" 2xl:mt-24 2xl:relative">
              ...
              <div className="2xl:absolute 2xl:ml-48 2xl:top-72 2xl:w-3/5">
                ...
                <p className="2xl:text-2xl 2xl:mt-6 2xl:text-left ">
                  ผู้ใช้สามารถกรอกข้อมูลสถานที่ที่คุณพบน้องแมว
                  หรือสถานที่ที่น้องหายไปได้ผ่าน Google map
                  และยังสามารถเพิ่มขอบเขตการค้นหา ได้อีกด้วย
                </p>
              </div>
            </div>
            <div className="">
              <Image src={IMAGES.step1} alt="step1" width="937" height="858" />
            </div>
          </div>
          <div className="2xl:grid 2xl:grid-cols-2 gap-7 2xl:mt-52 ">
            <div className="">
              <Image src={IMAGES.step2} alt="step2" width="937" height="719" />
            </div>
            <div className=" 2xl:mt-24 2xl:relative">
              ...
              <div className="2xl:absolute 2xl:ml-48 2xl:top-72 2xl:w-3/5">
                ...
                <p className="2xl:text-2xl 2xl:mt-6 2xl:text-left ">
                  ...
                  เจ้าของน้องแมว โดยอย่าลืมระบุข้อมูลที่จำเป็น ต่อการค้นหา
                  เท่าที่จะพอระบุได้ด้วยนะ
                </p>
              </div>
            </div>
          </div>
          <div className="2xl:grid 2xl:grid-cols-2 gap-7 2xl:mt-52 ">
            <div className=" 2xl:mt-24 2xl:relative">
              ...
              <div className="2xl:absolute 2xl:ml-48 2xl:top-72 2xl:w-3/5">
                ...
                <p className="2xl:text-2xl 2xl:mt-6 2xl:text-left ">
                  อีกทั้งทางเว็บไซต์ของเรายังมีระบบที่ช่วยผู้ใช้ ในการ
                  ตามหาน้องแมวหายโดยมี ฟังก์ชั่นที่เรียกว่า Dash Board
                  ซึ่งสามารถกลับมาดูได้ว่าหลังจากที่
                  เราโพสต์ตามหาน้องแมวหายไปแล้วนั้น มีโพสต์
                  ตามหาเจ้าของน้องแมวโพสต์ไหนบ้าง ที่ได้ถูกเพิ่ม
                  เข้ามาในบริเวณใกล้เคียงกับโพสต์ของคุณ
                </p>
              </div>
            </div>
            <div className="">
              <Image src={IMAGES.step3} alt="step3" width="937" height="882" />
            </div>
          </div>
          <div className="2xl:grid 2xl:grid-cols-2 gap-7 2xl:mt-52 ">
            <div className="">
              <Image src={IMAGES.step4} alt="step4" width="937" height="874" />
            </div>
            <div className=" 2xl:mt-24 2xl:relative">
              ...
              <div className="2xl:absolute 2xl:ml-48 2xl:top-72 2xl:w-3/5">
                ...
                <p className="2xl:text-2xl 2xl:mt-6 2xl:text-left ">
                  ผู้ใช้สามารถแก้ไขโปรไฟล์หรืออัพเดตข้อมูล ส่วนตัวได้ และยัง
                  สามารถเรียกดูโพสต์ของ ตนเองได้เพื่อแก้ไขข้อมูล และ“หากเมื่อพบ
                  น้องแมวแล้ว อย่าลืมกลับมาลบโพสต์ให้เรา ด้วยน้า”
                </p>
              </div>
            </div>
          </div>
          <div className="2xl:grid 2xl:grid-cols-2 gap-7 2xl:mt-52 ">
            <div className=" 2xl:mt-24 2xl:relative">
              ...
              <div className="2xl:absolute 2xl:ml-48 2xl:top-72 2xl:w-3/5">
                ...
                <p className="2xl:text-2xl 2xl:mt-6 2xl:text-left ">
                  เมื่อคุณเจอน้องแมวที่คุณตามหาแล้ว คุณสามารถ กดเข้าไปเพื่อดู
                  ข้อมูลเพิ่มเติมและข้อมูลติดต่อของ เจ้าของโพสต์ได้เลย
                  <br />
                  <br />
            ...
            <div className="">
              <Image src={IMAGES.step5} alt="step5" width="937" height="790" />
            </div>
          </div>
        </section>
      </main>
